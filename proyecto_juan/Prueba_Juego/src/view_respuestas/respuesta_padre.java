...
public class respuesta_padre extends JFrame{
	private static final long serialVersionUID = 1L;
	private JPanel contentPane;
	
	public respuesta_padre() {
		...
		JButton respuesta1_Button = new JButton("Hola papa");
		...
		JButton respuesta_Button = new JButton("Buenos dias aita");
		...
		JButton respuesta3_Button = new JButton("Ja... ja... Que gracioso");
		...
		JButton respuesta4_Button = new JButton("Wuantalamela");
