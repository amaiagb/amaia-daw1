...
public class respuesta_madre3 extends JFrame{
	private static final long serialVersionUID = 1L;
	private JPanel contentPane;
	
	public respuesta_madre3() {
		...
		JButton respuesta1_Button = new JButton("Ya la encontre");
		...
		JButton respuesta_Button = new JButton("La tengo");
		...
		JButton respuesta3_Button = new JButton("Estoy listo");
		...
		JButton respuesta4_Button = new JButton("No tarde na");
