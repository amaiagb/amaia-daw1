...
public class respuesta_nina2 extends JFrame{
	private static final long serialVersionUID = 1L;
	private JPanel contentPane;
	
	public respuesta_nina2() {
		...
		JButton respuesta1_Button = new JButton("Ahora te lo hago");
		...
		JButton respuesta_Button = new JButton("Toca hacer de hermano mayor");
		...
		JButton respuesta3_Button = new JButton("Va");
		...
		JButton respuesta4_Button = new JButton("'La lista de la familia'");
