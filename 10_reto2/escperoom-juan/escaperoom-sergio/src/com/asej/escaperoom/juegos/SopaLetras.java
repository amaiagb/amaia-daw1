                    ...
                    if(field.isEditable()) {
                    	if (palabrasCorrectas.contains(texto) && !palabrasEncontradas.contains(texto)) {
                            ...
                            if(palabrasEncontradas.size() == palabrasCorrectas.size()) {
                            	...
                            	ventana.getObjetosInventario().add(new Objeto("revista","revista.png", Ventana.mensajes.getString("sopa")));
                            	Ventana.mostrarTextoPantalla(Ventana.mensajes.getString("sopa1"));
                            }
                        } else {
                            field.setText("");
                        }
