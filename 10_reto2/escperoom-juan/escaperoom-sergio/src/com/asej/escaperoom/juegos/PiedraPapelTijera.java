...
public class PiedraPapelTijera extends JPanel {
	...
	public PiedraPapelTijera(Ventana ventana) {
		...
		lblTimer = new JLabel(Ventana.mensajes.getString("JLabel2"));
	...
	private void hacerBatalla(int p1Seleccion) {
		...
		switch (ganador) {
			...
			case "p1" -> { 
				...
				if(puntosP1 <5) {
					lblResultado.setText(Ventana.mensajes.getString("JLabel3"));
				} else {
					lblResultado.setFont(new Font("Tahoma", Font.PLAIN, 16));
					lblResultado.setText(Ventana.mensajes.getString("ganarPartida"));
					...
					Ventana.mostrarTextoPantalla(Ventana.mensajes.getString("mensajeGanar"));
				}
			}
			case "p2" -> { 
				puntosP2++;
				...
				if(puntosP2 <5) {
					lblResultado.setText(Ventana.mensajes.getString("JLabel4"));
				} else {
					lblResultado.setFont(new Font("Tahoma", Font.PLAIN, 16));
					lblResultado.setText(Ventana.mensajes.getString("mensajePierdes"));
					reiniciarPartida();
				}
			}
			case "empate" -> { 
	...
	private void reiniciarPartida() {
		...
		puntosP2 = 0;
		lblTimer.setFont(new Font("Tahoma", Font.PLAIN, 16));
		lblTimer.setText(Ventana.mensajes.getString("mensaje"));
