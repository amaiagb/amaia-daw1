...
public class respuesta_madre2 extends JFrame{
	private static final long serialVersionUID = 1L;
	private JPanel contentPane;
	
	public respuesta_madre2() {
		...
		JButton respuesta1_Button = new JButton("Aun tengo tiempo");
		...
		JButton respuesta_Button = new JButton("Voy corriendo");
		...
		JButton respuesta3_Button = new JButton("Ya se, ya se");
		...
		JButton respuesta4_Button = new JButton("Si....");
