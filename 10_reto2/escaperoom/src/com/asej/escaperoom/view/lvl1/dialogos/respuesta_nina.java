...
public class respuesta_nina extends JFrame{
	private static final long serialVersionUID = 1L;
	private JPanel contentPane;
	
	public respuesta_nina() {
		...
		JButton respuesta1_Button = new JButton("Vive y deja vivir");
		...
		JButton respuesta4_Button = new JButton("Hakuna matata");
