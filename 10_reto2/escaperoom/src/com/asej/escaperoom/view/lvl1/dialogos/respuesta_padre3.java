...
public class respuesta_padre3 extends JFrame{
	private static final long serialVersionUID = 1L;
	private JPanel contentPane;
	
	public respuesta_padre3() {
		...
		JButton respuesta1_Button = new JButton("Toma");
		...
		JButton respuesta_Button = new JButton("Lo he encontrado");
		...
		JButton respuesta3_Button = new JButton("Tu regalo de bodas");
		...
		JButton respuesta4_Button = new JButton("Pues me ha costado");
